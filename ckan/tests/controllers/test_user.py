...
class TestUserEdit(helpers.FunctionalTestBase):
    ...
    def test_edit_user(self):
        ...
        form['email'] = 'newmail@example.com'
        ...
        assert_equal(user.email, 'newmail@example.com')
...
class TestUserSearch(helpers.FunctionalTestBase):
    ...
    def test_user_page_anon_not_access(self):
        '''Anon users can not access the user list page'''
        app = self._get_test_app()
